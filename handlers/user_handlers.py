...
HELP_MESSAGE = ('Внимание! Это старая версия бота. Рекомендуем использовать новую версию. \n'
                'В нем реализован новый, более удобный функционал, повышена надежность и стабильность. \n'
                'Ссылка на новый бот: https://t.me/chavia_local_bot\n\n'
                'Для работы со старой версией бота используйте следующие режимы:\n'
...
async def proccess_start_command(message: Message):
    ...
    await message.answer('Внимание! Это старая версия бота. Рекомендуем использовать новую версию. \n'
                            'В нем реализован новый, более удобный функционал, повышена надежность и стабильность. \n'
                            'Ссылка на новый бот: https://t.me/chavia_local_bot\n\n'
                            'Приветствую. Вы запустили бот, который мониторит наличие в продаже билетов '
